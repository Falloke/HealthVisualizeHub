...
export async function GET(req: NextRequest) {
  try {
    ...
    const [mainCounts, compareCounts] = await Promise.all([
      queryGenderDeaths({ diseaseId, start_date, end_date, provinceNameTh: mainProvince }),
      queryGenderDeaths({ diseaseId, start_date, end_date, provinceNameTh: compareProvince }),
    ]);
